...
Finally, remember that linters exist to serve *you*. If a linter rule annoys you and your team, delete it. It may not be worth it. Learn from your own mistakes.cost on many fronts, especially when compared with gzip or lower compression levels of Brotli.